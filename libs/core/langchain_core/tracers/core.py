...
class _TracerCore(ABC):
    ...
    @abstractmethod
    def _persist_run(self, run: Run) -> None | Coroutine[Any, Any, None]:
        """Persist a run."""
    ...
    def _start_trace(self, run: Run) -> None | Coroutine[Any, Any, None]:  # type: ignore[return]
    ...
    def _end_trace(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """End a trace for a run."""
        return None

    def _on_run_create(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process a run upon creation."""
        return None

    def _on_run_update(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process a run upon update."""
        return None

    def _on_llm_start(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
    ...
    def _on_llm_end(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process the LLM Run."""
        return None

    def _on_llm_error(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process the LLM Run upon error."""
        return None

    def _on_chain_start(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process the Chain Run upon start."""
        return None

    def _on_chain_end(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process the Chain Run."""
        return None

    def _on_chain_error(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process the Chain Run upon error."""
        return None

    def _on_tool_start(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process the Tool Run upon start."""
        return None

    def _on_tool_end(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process the Tool Run."""
        return None

    def _on_tool_error(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process the Tool Run upon error."""
        return None

    def _on_chat_model_start(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process the Chat Model Run upon start."""
        return None

    def _on_retriever_start(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process the Retriever Run upon start."""
        return None

    def _on_retriever_end(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
        """Process the Retriever Run."""
        return None

    def _on_retriever_error(self, run: Run) -> None | Coroutine[Any, Any, None]:  # noqa: ARG002
